<?php 
	...
	class CategoryProductBuyController extends Controller{
		...
		public function index(){
			...
			$totalRecord = $this->totalRecordBuy();//ham trong model
			//tinh so trang
			if (isset($_SESSION["namecategory"])) {
				unset($_SESSION["namecategory"]);
			}
			$_SESSION["namecategory"]="buy";
			...
			$from = $p * $pageSize;
			//lay cac ban ghi
			$data = $this->fetchAllProductBuy($from,$pageSize);
