<?php 
	...
	class Controller{
		...
		public function renderHTML($fileName, $data = NULL){
			...
			$this->view = $content;
			//neu duong dan tai bien $fileLayout co ton tai thi xuat teamplate ra, neu khong thi chi xuat view trong MVC
			if($this->fileLayout != NULL && file_exists($this->fileLayout)) include $this->fileLayout;
			else
				echo $this->view;
		}
	}
