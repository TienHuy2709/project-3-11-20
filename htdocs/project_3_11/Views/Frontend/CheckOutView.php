            ...
            <div class="row contact">
                ...
                <div class="col-lg-7 hom-thu">
                    ...
                    <div class="container form-hom-thu">
                        <div class="row">
                            <form method="post" action="index.php?controller=Cart&action=doCheckOut" class="container-fluid">
                            <div class="form-inline" >
                                <input type="text" name="name" id="" class="form-control" placeholder="Tên" value="<?php echo isset($_SESSION['name'])?$_SESSION['name']:''; ?>" 
                                    aria-describedby="helpId" style="width: 49%; margin-bottom: 1rem; margin-right: 2%">
                                <input type="email" name="email" id="" class="form-control" placeholder="Email" <?php if(isset($record->email)): ?> disabled <?php endif; ?> value="<?php echo isset($_SESSION['email'])?$_SESSION['email']:''; ?>"
                                    aria-describedby="helpId" style="width: 49%; margin-bottom: 1rem;">
                                <input type="text" name="sdt" id="" class="form-control" placeholder="Số điện thoại" value="<?php echo isset($_SESSION['sdt'])?$_SESSION['sdt']:''; ?>" 
                                    aria-describedby="helpId" style="width: 49%; margin-bottom: 1rem; margin-right: 2%">
                                <input type="text" name="diachi" id="" class="form-control" placeholder="Địa chỉ" value="<?php echo isset($_SESSION['diachi'])?$_SESSION['diachi']:''; ?>" 
                                    aria-describedby="helpId" style="width: 49%; margin-bottom: 1rem;">
                            </div>
                            <p style="font-size: 15px; opacity: 0.5;text-align: center;">Shop sẽ liên hệ với bạn để xác nhận trong 12h tới. Bạn hãy để ý điện thoại giúp Shop nhé. Cám ơn bạn đã ủng hộ</p>
                            <div style=""><button type="submit" class="btn btn-submit hvr-icon-wobble-vertical" >Đặt hàng&nbsp;&nbsp;&nbsp;<i class="fas fa-shopping-basket hvr-icon"></i></button>
                            <button type="reset" class="btn btn-submit hvr-icon-wobble-vertical" value="" >Viết lại&nbsp;&nbsp;&nbsp;<i class="fas fa-pencil-alt hvr-icon"></i></button>
                            </div>
                            </form>
                        </div>
                    </div>
