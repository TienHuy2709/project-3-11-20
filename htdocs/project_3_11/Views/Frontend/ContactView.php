            ...
            <div class="row contact">
                ...
                <div class="col-lg-7 hom-thu">
                    ...
                    <div class="container form-hom-thu">
                        <div class="row">
                            <form method="post" action="index.php?controller=Contact&action=addContact" class="container-fluid">
                            <div class="form-group">
                                <input type="text" name="name" id="" class="form-control" placeholder="Họ và tên"
                                    aria-describedby="helpId" value="<?php echo isset($_SESSION['name'])?$_SESSION['name']:''; ?>" style="width: 100%">
                                <input type="text" name="email" id="" class="form-control" placeholder="Địa chỉ Email"
                                    aria-describedby="helpId" value="<?php echo isset($_SESSION['email'])?$_SESSION['email']:''; ?>" style="width: 100%">
                            </div>
                            <div class="form-group">
                                <textarea name="content" id="" class="form-control" cols="30" rows="10" style="width: 100%; height: 100%" placeholder="Nội dung góp ý"></textarea>
                            </div>
                            <button type="submit" class="btn btn-submit hvr-icon-wobble-vertical" style="" onclick="return window.alert('Gửi thành công');">Gửi&nbsp;&nbsp;&nbsp;<i class="fas fa-paper-plane hvr-icon"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
