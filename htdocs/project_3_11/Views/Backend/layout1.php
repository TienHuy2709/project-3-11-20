...
<head>
  ...
  <script src="Assets/Backend/ckeditor/ckeditor.js" type="text/javascript" charset="utf-8" ></script>
  ...
  <link href="Assets/Backend/layout1/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
  ...
  <script src="Assets/Backend/layout1/vendor/chart.js/Chart.min.js"></script>
  <script src="Assets/Backend/layout1/vendor/datatables/jquery.dataTables.js"></script>
  <script src="Assets/Backend/layout1/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="Assets/Backend/layout1/js/sb-admin.min.js"></script>

  <!-- Demo scripts for this page-->
  <script src="Assets/Backend/layout1/js/demo/datatables-demo.js"></script>
  <script src="Assets/Backend/layout1/js/demo/chart-area-demo.js"></script>
                        <style type="text/css">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div class="navbar-brand mr-1"><a  href="index.php"><img style="width: 10%;" src="Assets/frontend/img/avatar.jpg"></a>
      <span>NTH ADMIN</span>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="index.php?area=Backend&controller=LogIn" onclick="return window.confirm('Bạn có chắc chắn muốn đăng xuất');">Logout</a>
        </div>
      </li>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?area=Backend&controller=Category&p=1">
          <i class="fas fa-fw fa-table"></i>
