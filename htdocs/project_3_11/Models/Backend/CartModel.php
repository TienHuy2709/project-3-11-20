<?php 
	trait CartModel{
		...
		public function listProduct($id){
			...
			$conn = Connection::getInstance();
			//thuc thi truy van
			$query = $conn->query("select * from tbl_order_detail inner join tbl_product on tbl_order_detail.product_id=tbl_product.product_id where tbl_order_detail.order_id=$id");
			//tra ve tong so luong ban ghi
			return $query->fetchAll();
		}
